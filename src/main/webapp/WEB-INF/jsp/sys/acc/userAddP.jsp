										...
										<div class="list-area">
											<ul>
												<li>
													...
													<div class="list-item">
														<input type="text" id="userId" name="userId" maxlength="40" placeholder="사용자ID를 검색해주세요." style="width: calc(100% - 6.7rem)">
												...
												<li>
													...
													<div class="list-item">
														<input type="text" id="orgKorNm" name="orgKorNm" placeholder="선택" style="width: calc(100% - 6.7rem)">
											...
											<div class="btn-wrap btn-biggest">
												<button type="button" class="btn fullblue" onclick="goAdd();">등록</button>
