...
<div class="cont single-style">
	...
	<form id="popTempInfoForm" name="popTempInfoForm" method="post">
		...
		<fieldset>
			<legend>탬플릿 정보수정</legend>
			<h3 class="pop-title">탬플릿 정보수정</h3>
				...
				<div class="list-area">
					<ul>
						<li class="col-full">
							...
							<div class="list-item">
								<input type="text" name="tempNm" value="<c:out value='${tempInfo.tempNm}'/>" placeholder="탬플릿명을 입력해주세요.">
							</div>
						</li>
						<li class="col-full">
							<label>설명</label>
							<div class="list-item">
								<textarea name="tempDesc" placeholder="탬플릿 설명을 입력해주세요."><c:out value='${tempInfo.tempDesc}'/></textarea>
							</div>
						</li>
						<li class="col-full">
