					...
					<section class="cont-body">
						...
						<div class="manage-wrap">
							<form id="searchForm" name="searchForm" method="post">
								<input type="hidden" name="page" value="<c:out value='${searchVO.page}'/>" /> <input type="hidden" name="searchStartDt" value="<c:out value='${searchVO.searchStartDt}'/>" /> <input type="hidden" name="searchEndDt" value="<c:out value='${searchVO.searchEndDt}'/>" /> <input type="hidden" name="searchTempNm" value="<c:out value='${searchVO.searchTempNm}'/>" /> <input type="hidden" name="searchDeptNo" value="<c:out value='${searchVO.searchDeptNo}'/>" /> <input type="hidden" name="searchUserId" value="<c:out value='${searchVO.searchUserId}'/>" /> <input type="hidden" name="searchStatus" value="<c:out value='${searchVO.searchStatus}'/>" />
							</form>
							<form id="templateInfoForm" name="templateInfoForm" method="post">
								<input type="hidden" id="tempNo" name="tempNo" value="<c:out value='${tempInfo.tempNo}'/>" /> <input type="hidden" id="channel" name="channel" value="<c:out value='${tempInfo.channel}'/>" /> <input type="hidden" id="tempVal" name="tempVal" value=""> <input type="hidden" id="tempFlPath" name="tempFlPath" value="<c:out value='${tempInfo.tempFlPath}'/>" />
								<fieldset>
									...
									<div class="graybox">
										...
										<div class="list-area">
											<ul>
												...
												<li><label class="required">상태</label>
													<div class="list-item">
														<div class="select">
									...
									<div class="graybox">
										...
										<div class="list-area">
											<ul>
												<li class="col-full"><label class="required">탬플릿명</label>
													<div class="list-item">
														<input type="text" id="tempNm" name="tempNm" value="<c:out value='${tempInfo.tempNm}'/>" placeholder="탬플릿명을 입력해주세요.">
													</div></li>
												<li class="col-full"><label>설명</label>
													<div class="list-item">
														<textarea id="tempDesc" name="tempDesc" placeholder="탬플릿 설명을 입력해주세요."><c:out value='${tempInfo.tempDesc}' /></textarea>
													</div></li>
												<li class="col-full">
													<!-- 에디터 영역// -->
													<div class="editbox">
