...
<%
    //태그명
    String idTagName, pwdTagName, credTagName, returnUrlTagName, siteTagName, codeTagName;
    ...
    try {
        ...
        codeTagName = ssoProvider.getParamName(AuthUtil.ParamInfo.CODE);
...
<form id="form1" method="post" action="<%=ssoLogonUrl%>">
    <table>
        ...
        <tr>
            <td>보안코드 :</td>
            <td><input type="text" id="txtCode" name="<%=codeTagName%>"/></td>
        </tr>
        <tr>
